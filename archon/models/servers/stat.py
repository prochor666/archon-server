...
from archon import utils


def network(sample1, sample2, stats) -> list:
...
def get_net_streams(devices_data, sample1, sample2) -> list:
...
def parse_net_streams(line1, line2) -> dict:
...
def get_alive_devices(stats) -> dict:
...
def cpu_load(sample1, sample2) -> list:
...
def cpu_percentage(stat1, stat2) -> list:
