...
from archon.network import remote
from archon.models.servers import servers, stat


def survey(id: str) -> dict:
...
def compose_monitor_tasks(id: str) -> dict | bool:
    ...
    tasks = [
        'cat /opt/archon/stats/archon-monitor.data',
    ]
...
def parse_monitor_result(raw) -> dict:
